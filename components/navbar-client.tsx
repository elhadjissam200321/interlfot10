    ...
    <>
      ...
      >
        <div className="flex items-center justify-between px-6 md:px-12 h-16">
          ...
          <nav className="hidden md:flex items-center gap-10">
            ...
            <ProductsDropdown variant={scrolled ? 'dark' : 'light'} label={uiStrings?.nav_products} />

            <CollectionsDropdown variant={scrolled ? 'dark' : 'light'} label={uiStrings?.nav_collections} />
          ...
          <div className="md:hidden flex items-center gap-3">
            ...
            <button
              ...
              className={`flex flex-col gap-1.5 p-1 transition-colors ${scrolled ? 'text-foreground' : 'text-background'}`}
              aria-label="Menu"
            >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 h-16 shrink-0">
          {/* Logo placeholder to keep layout balanced */}
